...
![img](image/944365-0896ba8d9155140e.png)
...
![img](image/944365-7c9ff656ebd1b981.png)
...
![img](image/944365-0ae738c6d50c0adf.png)
...
- 特点
  ...
  1. 接收广播按顺序接收
  2. 先接收的广播接收者可以**对广播进行截断**，即后接收的广播接收者不再接收到此广播；
  3. 先接收的广播接收者可以**对广播进行修改**，那么后接收的广播接收者将接收到被修改后的广播
